# Backup of original encrypted models
# This file contains the original encrypted field definitions
# Use this as reference if you want to restore encryption later
...
# Original encrypted models (for reference)
